...
/**
 * Store exception log. Save different type error using codes or strings.
 * Allow adding new error codes and their descriptions.
...
public class ExceptionManager {
	...
	/**
	 * Split main string into Array whit strings containing all errors saved
	 * to the moment of invocation.
	 ...
	 * @param mess message that will be added.
	 */
	 ...
	 * @param key that will be added.
	 * @param description tath will be added.
	 */
